    ...
    <main className="min-h-screen overflow-hidden bg-[#06111f] text-slate-100">
      ...
      <section className="relative z-10 mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-28 lg:pt-28">
        <div className="flex flex-col justify-center">
          <div className="mb-7 inline-flex w-fit items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-300/10 px-3 py-1.5 text-xs font-medium text-emerald-200"><span className="h-1.5 w-1.5 rounded-full bg-emerald-300 shadow-[0_0_12px_#6ee7b7]" /> v1 · Edge-ready operations</div>
          <h1 className="max-w-3xl text-5xl font-semibold leading-[1.03] tracking-[-0.04em] text-white sm:text-6xl lg:text-7xl">Operational intelligence when the network cannot be trusted.</h1>
          <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-400">REX turns field observations and equipment signals into traceable operational events. Capture offline. Sync deliberately. Inspect the evidence chain.</p>
